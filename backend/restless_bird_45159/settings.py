"""
Django settings for restless_bird_45159 project.
...
ROOT_URLCONF = 'restless_bird_45159.urls'
...
WSGI_APPLICATION = 'restless_bird_45159.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_bird_45159 API",
    "DESCRIPTION": "API documentation for restless_bird_45159 App",
    "VERSION": "v1",
}
